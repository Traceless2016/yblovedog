...
#define OLED_MOSI   D1 // OLED 的 D1 脚，在 SPI 和 IIC 通信中为数据管脚
#define OLED_CLK   D2 // D0引脚，在 SPI 和 IIC 通信中为时钟管脚
#define OLED_DC    D5 // OLED 的 D/C#E 脚，数据和命令控制管脚

// #define OLED_CS    D6 // OLED 的 CS#脚，也就是片选管脚
#define OLED_CS    D3 // OLED 的 CS#脚，也就是片选管脚

// #define OLED_RESET D7 // OLED 的 RES#脚，用来复位（低电平复位）
#define OLED_RESET D0 // OLED 的 RES#脚，用来复位（低电平复位）
